    ...
    <div class="one-category">
        ...
        <div class="swiper game-swiper">
            <div class="swiper-wrapper" style="height: 100px;"> <!-- Defina a altura desejada em pixels -->
                @foreach($gameListData['data'] as $game)
                ...
                <div class="swiper game-swiper">
                    <div class="swiper-wrapper" style="height: 1rm;">
                        ...
                        <div class="banners-slots">
                            ...
                            <div class="banner-slot" data-game="{{ $v }}">
                                <input type="hidden" value="{{$v}}">
                                <img src="../img/banners-games/{{ $v }}.png" />
                            </div>
                            @endforeach
                        </div>
