        ...
        <div class="game">
                ...
                <div class="sidebar-block">
                    <div class="bet-component">
                        <div class="bet-form">
                            ...
                            <button type="button" style="display: none;" class="btn btn-green btn-play"
                                id="btnFinishMines" onclick="finishMines()"><span>Retirar <span
                                        id="winMines">0.00</span></span>
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <div class="game-component">
                ...
                <div class="tower_tower__1ms3K">
                    <iframe
                        src="https://api-test.salsagator.com/game?token=fc8b096c103702de9fa03833993f91dd &pn=playbet-staging&lang=pt&game=superHotBingo"
